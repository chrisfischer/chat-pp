...
void print_help_message()
{
  ...
  cout << "1. help : Type this command at any time to see this help menu again." << endl;
  cout << "2. enter <chatroom> : This command is available when you are not a member of a chatroom. Type this command and the users of <chatroom> will vote on whether to let you in. If they vote yes, you will be entered into <chatroom>." << endl;
  cout << "3. leave : This command is available when you are a member of a chatroom. Type this command to leave the chatroom." << endl;
  cout << "4. set nickname <new_nickname> : This command is available when you are inside a chatroom and is used to change your nickname inside that chatroom." << endl;
  cout << "5. kick <nickname> : This command is available when you are inside a chatroom and is used to kick someone out of the chatroom. If no one exists with the nickname <nickname> nothing will happen." << endl << endl;
}
...
string prompt_cli()
{
  ...
  print_help_message();
  cout << "In order to get started, please specify the IP address you would like to connect to." << endl << "IP Address:" << endl;
...
void parse_input(string &input, ClientServerAPI& csAPI) {
  if (!input.compare("help")) {
    ...
    cout << "Users from " << room << " will now vote on whether to let you in the room." << endl;
  } else if (!csAPI.in_room()) {
    cout << "You are not currently in a chatroom. Type enter <chatroom> to enter a room." << endl;
